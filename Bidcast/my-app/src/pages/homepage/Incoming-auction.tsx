...
export function ComingAuction() {
  return (
    <div>
      <Container>
        <h4 className="Incoming_auction">Incoming Auction</h4>
        ...
        >
          <div>
            <Card style={{ width: "95%", marginTop: "20px", overflow:"hidden" }}>
              <Image
                className="img_fluid"
              ...
              <Card.Body>
                <div className="counter">
                  ...
                  <div className="countdown_time">
                    <div className="time_value">00</div>
                    <div className="time_label">Minutes</div>
                  </div>
                  <div className="countdown_time">
                    <div className="time_value">00</div>
                    <div className="time_label">Seconds</div>
                  </div>
                </div>
                <Card.Title>Product name</Card.Title>
                <Card.Text>Current Bid: <span className="biding_price">HKD 100</span></Card.Text>
            ...
            <div>
              <Card style={{ width: "95%", marginTop: "20px", overflow:"hidden" }}>
                ...
                <Card.Body>
                  ...
                  <Card.Title>Product name</Card.Title>
                  <Card.Text>Auction Ended</Card.Text>
                  {/* <Button variant="primary">Bid Now</Button> */}
                </Card.Body>
              </Card>
            </div>
